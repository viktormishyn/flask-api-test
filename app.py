...
@app.route('/api/planet_details/<int:planet_id>', methods=['GET'])
...
@app.route('/api/update_planet', methods=['PUT'])
@jwt_required()
def update_planet():
...
@app.route('/api/remove_planet/<int:planet_id>', methods=['DELETE'])
@jwt_required()
def remove_planet(planet_id: int):
    ...
    if planet:
        ...
        return jsonify(mesaage="That planet does not exist"), 404
